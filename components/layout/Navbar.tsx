  ...
  return (
    <>
      ...
      >
                ...
                <ScrollArea className="h-[calc(100vh-8rem)]">
                  <nav className="flex flex-col p-4">
                    ...
                    <Button
                      variant="ghost"
                      onClick={toggleTheme}
                      className="mt-4 justify-start hover:bg-muted cursor-pointer"
                    >
                      {theme === "light" ? (
        ...
        {/* Trending cards shown on desktop */}
      ...
      {isSearchOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-16 sm:pt-24">
          ...
          ></div>
          <Command className="w-full max-w-lg rounded-lg border border-border bg-card shadow-lg">
            <CommandInput placeholder="Tìm kiếm bài viết, tác giả..." />
            <CommandList>
              <CommandEmpty>Không tìm thấy kết quả.</CommandEmpty>
              <CommandGroup heading="Bài viết gần đây">
                <CommandItem className="flex items-center">
                  <FileText className="mr-2 h-4 w-4" />
                  <span>Hướng dẫn thiết kế UI với Tailwind CSS</span>
                </CommandItem>
                <CommandItem className="flex items-center">
                  <FileText className="mr-2 h-4 w-4" />
                  <span>Tối ưu NextJS App Router</span>
                </CommandItem>
                <CommandItem className="flex items-center">
                  <FileText className="mr-2 h-4 w-4" />
                  <span>TypeScript vs JavaScript: So sánh toàn diện</span>
                </CommandItem>
              </CommandGroup>
              <CommandGroup heading="Tác giả">
                <CommandItem className="flex items-center">
                  <User className="mr-2 h-4 w-4" />
